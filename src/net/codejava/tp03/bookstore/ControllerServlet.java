package net.codejava.tp03.bookstore;
...
public class ControllerServlet extends HttpServlet {
    ...
    private void showCredits(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException, ServletException {
